...
<?php $this->beginPage() ?>
    ...
    <body>
    <?php $this->beginBody() ?>
    <div class="tm-page-wrap mx-auto" style="overflow: hidden !important;">
        <div class="position-relative">
            ...
            <div class="tm-welcome-containerUser ">
                <?= $content ?>
            </div>

            <div id="tm-video-container" style="max-height: 50% !important">
                <video autoplay muted loop id="tm-video" style="height: 980px !important;">
                    <source src="/web/video/wheat-field.mp4" type="video/mp4">
                </video>
            </div>

            <i id="tm-video-control-button" class="fa fa-minus" style="color: white"></i>
